// Kumpulan icon SVG line-style (24x24, stroke currentColor) untuk dashboard.
// Dibuat inline karena project belum memakai icon library eksternal.
...
export function CornerUpRightIcon({ className }: IconProps) {
  return (
    <svg {...baseProps(className)}>
