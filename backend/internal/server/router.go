...
func NewRouter(cfg *config.Config, st *store.Store) (*gin.Engine, *handler.Handler) {
	...
	admin.GET("/approval-matrices", h.ListApprovalMatrices)
	admin.POST("/approval-matrices", h.CreateApprovalMatrix)
	admin.PUT("/approval-matrices/:id", h.UpdateApprovalMatrix)
	admin.DELETE("/approval-matrices/:id", h.DeactivateApprovalMatrix)
	admin.POST("/approval-categories", h.CreateApprovalCategory)
	admin.PUT("/approval-categories/:id", h.UpdateApprovalCategory)
	admin.DELETE("/approval-categories/:id", h.DeactivateApprovalCategory)
	admin.GET("/coordination-scope-rules", h.ListCoordinationScopeRules)
	admin.PUT("/coordination-scope-rules/:scope", h.UpdateCoordinationScopeRule)
