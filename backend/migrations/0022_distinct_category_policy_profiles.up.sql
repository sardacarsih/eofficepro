...
SET max_final_level = CASE
        WHEN ac.code = 'SDM' AND am.originator_level IN ('division_head', 'sub_dept_head') THEN 'vp_director'
        WHEN ac.code = 'KEUANGAN' AND am.originator_level IN ('dept_head', 'gm') THEN 'president_director'
